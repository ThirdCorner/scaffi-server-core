...
var Sequelize = function (_AbstractComponent) {
	...
	_createClass(Sequelize, [{
		...
		key: '_parseFixture',
		value: function _parseFixture(fixtures, filename, file, parentName, parentValue) {
     ...
     */
			...
			//domain: "JJSPC"
			return new _sequelize2.default(this.getParam("databaseName"), this.getParam("username"), this.getParam("password"), opts);
