...
var Redis = function (_AbstractComponent) {
	...
	_createClass(Redis, [{
		key: 'setup',
		value: function setup(app, redis) {
			var _this2 = this;

			var that = this;
			var redisConnectInterface = {
				registerStore: function registerStore(registerObj) {
					var store = (0, _connectRedis2.default)(registerObj);

					var obj = {
						host: _this2.getParam("host") || 'localhost',
						port: _this2.getParam("port") || 6379,
						client: redis
					};
