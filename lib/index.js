	...
	_createClass(CoreLoader, [{
		...
		value: function loadConfig() {
			...
			if (privateConfig && privateConfig.components) {
				_lodash2.default.each(privateConfig.components, function (item, componentName) {
					if (item && _lodash2.default.isObject(item)) {
						_lodash2.default.each(item, function (propValue, propName) {
							if (!_lodash2.default.has(config.components, componentName)) {
